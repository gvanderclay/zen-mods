...
const requireIdleOwner = (owner, path, failures, { registrations, phase }) => {
  ...
  if (owner.protocol !== 7) {
    addFailure(failures, `${path}.protocol`, "must be protocol 7");
  }
  if (
...
const requirePreferenceLane = (
  ...
  if (!isPlainObject(during)) {
    ...
    if (during.protocol !== 7) {
      addFailure(failures, `${path}.ownerDuring.protocol`, "must be protocol 7");
    }
